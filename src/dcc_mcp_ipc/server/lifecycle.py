"""Server lifecycle management for DCC-MCP-IPC.
...
from dcc_mcp_ipc.server.factory import create_dcc_server as _create_dcc_server
from dcc_mcp_ipc.server.factory import create_raw_threaded_server
