"""Error handling utilities for DCC-MCP-IPC.

This module provides error models and error handling utilities for the DCC-MCP-IPC package.
"""
...
class DCCMCPError(Exception):
    """Base exception class for DCC-MCP-IPC errors.

    This class provides a common base for all DCC-MCP-IPC specific exceptions.
