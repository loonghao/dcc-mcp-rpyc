...
# ---------------------------------------------------------------------------
# URL builders for supported DCC types
# ---------------------------------------------------------------------------

_UNREAL_ENDPOINTS = {
    "actors": "/remote/object/call",
    "property": "/remote/object/property",
    "open_level": "/api/v1/unreal/level/action?action=open",
}

_UNREAL_ACTOR_CLASSES = {
    "meshes": "/Script/Engine.StaticMeshActor",
    "cameras": "/Script/Engine.CameraActor",
    "lights_point": "/Script/Engine.PointLightComponent",
    "lights_spot": "/Script/Engine.SpotLightComponent",
    "lights_directional": "/Script/Engine.DirectionalLightComponent",
    "lights_area": "/Script/Engine.RectLightComponent",
}
