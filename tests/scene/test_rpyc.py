    ...
    def test_aggregation(self, mock_execute) -> None:
        ...
        def side_effect(code):
            if "filter" in code.lower() or "objects" in code.lower():
                return [{"name": "pCube1", "type": "mesh", "path": "|pCube1", "parent": "", "children": [], "visibility": True, "material": "", "transform_matrix": None, "metadata": {}}]
            elif "hierarchy" in code.lower():
                return {"root_name": "|", "total_objects": 1, "max_depth": 1, "tree": {"name": "|", "children": [{"name": "pCube1", "children": []}]}}
            elif "material" in code.lower():
                return [{"name": "lambert1", "type": "Lambert", "assigned_objects": ["pCube1"], "properties": {}}]
            elif "camera" in code.lower():
                return [{"name": "persp", "type": "perspective", "focal_length": 35.0, "field_of_view": 54.4, "near_clip": 0.1, "far_clip": 10000.0}]
