...
class TestSceneQueryFilter:
    ...
    def test_all_values(self) -> None:
        expected = [
            "all", "meshes", "cameras", "lights", "shapes",
            "joints", "visible_only", "selected_only", "custom",
        ]
...
def _make_concrete_scene_info(**kwargs) -> BaseSceneInfo:
    ...
    class ConcreteSceneInfo(BaseSceneInfo):
        ...
        def get_objects(self, filter_=None): return []

        def get_hierarchy(self): return SceneHierarchy(root_name="world")
...
class TestBaseSceneInfo:
    ...
    def test_get_full_scene_info(self) -> None:
        ...
        class FullTestScene(BaseSceneInfo):
            def _dcc_type(self): return "test"

            def get_objects(self, f=None):
                return [obj]

            def get_hierarchy(self):
                return SceneHierarchy(root_name="world", total_objects=1, tree={"name":"world","children":[{"name":"test_obj","children":[]}]})
    ...
    def test_get_full_scene_info_excludes_optional_when_configured(self) -> None:
        ...
        class MinimalScene(BaseSceneInfo):
            def _dcc_type(self): return "minimal"
            def get_objects(self, f=None): return []
            def get_hierarchy(self): raise NotImplementedError
            def get_materials(self): raise NotImplementedError
            def get_cameras(self): return []
            def get_lights(self): return []
            def get_selection(self): return []
    ...
    def test_get_full_scene_info_propagates_scene_error(self) -> None:
        ...
        class FailingScene(BaseSceneInfo):
            def _dcc_type(self): return "failing"
            def get_objects(self, f=None): raise SceneError("objects fail", dcc_type="failing")
            def get_hierarchy(self): ...
            def get_materials(self): ...
            def get_cameras(self): ...
            def get_lights(self): ...
    ...
    def test_get_full_scene_info_wraps_generic_exception(self) -> None:
        ...
        class BrokenScene(BaseSceneInfo):
            def _dcc_type(self): return "broken"
            def get_objects(self, f=None): raise RuntimeError("boom")
            def get_hierarchy(self): ...
            def get_materials(self): ...
            def get_cameras(self): ...
            def get_lights(self): ...
